...
jest.spyOn(global, "fetch").mockImplementation(() =>
  ...
  test("usean tavaran testausta", async () => {
    const fakeData2 = 
      {0:{id: "608", name: "lokiTest11", amount: "67", location: "B2", category: "test_category1", image: "juu", number: "464735", __v: 0},
      1:{id: "12314", name: "lokiTest15", amount: "15", location: "B1", category: "test_category3", image: "joo", number: "46474", __v: 0}};
  jest.spyOn(global, "fetch").mockImplementation(() =>
        Promise.resolve({
